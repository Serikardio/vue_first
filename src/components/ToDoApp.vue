        ...
        <div style="height: 550px;"  class="overflow-auto">
          ...
          <ul class="mb-8">
            <li class="font-normal" v-for="tag in tags" :key="tag.id">
              <div class="flex mb-2 items-center justify-between bg-gray-300 rounded-lg p-2">
                <div class="flex">
  <!--                ReadyBTN-->
                  ...
                  <button v-else @click="handleClick(tag.id)">
                   ...
                   <div>
                    <p :style="{ 'text-decoration': tag.name.textDecoration }" @click="handleClick(tag.id)">{{ tag.name.text }}</p>
                   </div>

                  <div v-show="show" class="flex items-center my-1">
                ...
                <div>
                  <button @click="selected(tag.id)" class="flex items-center hover:bg-gray-200 rounded">
              ...
              <div  v-show="selectedID === tag.id" class="absolute ml-2 rounded w-auto p-2 h-auto bg-gray-200 -mt-3" style="right: 470px;" >
                <button @click="toggleDetails(tag.id)" class="text-sm flex items-center my-1">
                ...
                <button @click="handleClick(tag.id)" class="text-sm flex items-center my-1">
                ...
                <button @click="removeTag(tag.id)" class="text-sm flex items-center my-1 text-red-500">
        ...
        <div  class="flex items-center" >
           <div style="width: 620px;" class="flex items-center" >
             ...
             <input v-model="l_new_section"
                    @input="updateSection"
                    class="border flex items-center h-10 px-2"
                    placeholder="Section">
